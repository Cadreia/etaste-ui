...
import { Clock, Heart, Award, MapPin, Edit3, Star } from "lucide-react";
  ...
  const achievements = [
    {
      ...
      description: "Tried recipes from 10+ countries",
      icon: "🌍",
    },
    {
      title: "Spice Master",
      description: "Completed 5 spicy recipes",
      icon: "🌶️",
    },
    {
      title: "Quick Cook",
      description: "Mastered 10 recipes under 30 minutes",
      icon: "⚡",
    },
    {
      title: "Vegetarian Specialist",
      description: "Tried 15 vegetarian recipes",
      icon: "🥬",
    },
  ];
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600 mb-2">
                  Food enthusiast from San Francisco, CA
                </p>
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {achievements.map((achievement, index) => (
                    <div
                      key={index}
                      className="flex items-center space-x-4 p-4 bg-gradient-to-r from-orange-50 to-red-50 rounded-lg"
                    >
