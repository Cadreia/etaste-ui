    ...
    steps: [
      {
        ...
        description:
          "Cook 2 cups of short-grain rice according to package instructions. Keep warm in the rice cooker or cover with a lid.",
        time: 20,
        image:
      ...
      },
      {
        ...
        description:
          "Blanch spinach in boiling water for 30 seconds, then shock in ice water. Julienne carrots and zucchini into thin strips.",
        time: 15,
        image:
      ...
      },
      {
        ...
        description:
          "Season each vegetable separately with sesame oil, soy sauce, minced garlic, and a pinch of salt. Let marinate for 10 minutes.",
        time: 10,
        image:
          "https://images.pexels.com/photos/1435163/pexels-photo-1435163.jpeg?auto=compress&cs=tinysrgb&w=600",
        tips: "Don't mix vegetables together yet - each should maintain its distinct flavor.",
      },
      {
        title: "Cook protein",
        description:
          "If using beef, slice thin and marinate in soy sauce, sesame oil, and ginger. Cook in a hot pan for 2-3 minutes.",
        time: 10,
        image:
      ...
      },
      {
        title: "Fry eggs",
        description:
          "Heat a non-stick pan and fry eggs sunny-side up. The yolk should be slightly runny for authentic bibimbap.",
        time: 5,
        image:
      ...
      },
      {
        ...
        description:
          "Place warm rice in bowls, arrange vegetables and protein in sections on top, add fried egg in center, and serve with gochujang.",
        time: 5,
        image:
              ...
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Estimated time: {currentStepData.time} minutes
                  </p>
                </div>
              </div>
        ...
        {completedSteps.length === totalSteps && (
          <div className="mt-8 text-center bg-green-900/30 border border-green-500/30 rounded-2xl p-8">
            ...
            <p className="text-green-200 mb-6">
              You've successfully completed {recipe.title}!
            </p>
            <Link
              to="/"
